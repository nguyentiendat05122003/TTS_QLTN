                ...
                <div className="card">
                    <DataTable value={loaiThietBi} showGridlines paginator rows={10} rowsPerPageOptions={[5, 10, 25, 50, 100]}>
                        ...
                        <Column header="Thao tác" body={(rowData) => (
                            <>
                                <Button size="small" title='Sửa' className='w-2rem h-2rem mb-1 mr-1' icon="pi pi-pencil" onClick={() => onEdit(rowData)} />
                                <Button size="small" title='Xóa' className='w-2rem h-2rem mb-1' icon="pi pi-trash" severity='danger' onClick={() => onDelete(rowData)} />
                            </>
                        )} />
                    </DataTable>
                </div>
